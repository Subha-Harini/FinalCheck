	...
	AppUserDetailsService appUserDetailsService;
	    ...
	    protected void configure(HttpSecurity httpSecurity) throws Exception {
	        ...
	        httpSecurity.csrf().disable().httpBasic().and()
	            .authorizeRequests()
	            .antMatchers("/stockmarketcharting/list").authenticated()
	            .antMatchers("/stockmarketcharting/list/{id}").authenticated()
	            .antMatchers("/company-list/{stockExchangeName}").authenticated()
	            .and()
